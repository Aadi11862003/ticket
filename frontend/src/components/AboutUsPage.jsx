...
const AboutUsPage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#b8d3e7] p-8">
      <div className="max-w-4xl w-full bg-white border border-[#D1D1D1] rounded-lg shadow-lg p-8">
        <h1 className="text-4xl font-bold text-center text-[#04092C] mb-6">About Us</h1>
        <p className="text-lg text-[#04092C] mb-4 border-l-4 border-[#04092C] pl-4 bg-[#E6E6FA] rounded-md">
        ...
        <h2 className="text-2xl font-semibold text-[#04092C] mb-4">Our Team</h2>
        <p className="text-lg text-[#04092C] mb-4 border-l-4 border-[#04092C] pl-4 bg-[#E6E6FA] rounded-md">
        ...
        <h2 className="text-2xl font-semibold text-[#04092C] mb-4">Our Vision</h2>
        <p className="text-lg text-[#04092C] mb-4 border-l-4 border-[#04092C] pl-4 bg-[#E6E6FA] rounded-md">
        ...
        <h2 className="text-2xl font-semibold text-[#04092C] mb-4">Contact Us</h2>
        <p className="text-lg text-[#04092C] mb-4 border-l-4 border-[#04092C] pl-4 bg-[#E6E6FA] rounded-md">
