...
const Finished = () => {
  ...
  return (
    <div className="bg-white min-h-screen text-black flex flex-col items-center justify-center py-8">
      <div className="flex flex-col md:flex-row items-start justify-center w-11/12 max-w-5xl">
        ...
        <div className="flex flex-col items-center w-full md:w-1/2 lg:w-3/5">
          ...
          {visibleDescription && (
            <p className="underline underline-offset-4 text-lg text-black mt-4">
        ...
        <div className="p-6 w-full md:w-1/2 lg:w-2/5 text-center md:text-left">
          ...
          <div className="border border-gray-400 rounded-lg p-4 max-w-ms">
            <div className="mb-6 md:mb-0">
              <h1 className="title font-size-30px text-3xl font-bold text-violet-500">The Arijit Singh Live Concert</h1>
            </div>

            {visibleDetail >= 1 && (
              <p className="text-lg mb-4 flex items-center transition-opacity duration-500">
                <FontAwesomeIcon icon={faTicketAlt} className="text-violet-400 mr-2" />
                400
              </p>
            )}
            {visibleDetail >= 2 && (
            ...
            <div className="border border-gray-400 rounded-lg p-4 max-w-ms">
            <p className="text-xl text-violet-600 font-semibold mb-2">Event Guide
            <hr className="my-4 w-3/4 border-t border-gray-400" />
            </p>
            
            {visibleDetail >= 5 && (
              <p className="text-lg mb-4 flex items-center transition-opacity duration-500">
                <FontAwesomeIcon icon={faHourglassHalf} className="text-violet-400 mr-2" />
                3 hours
              </p>
            )}
            ...
            {visibleDetail >= 4 && (
              <p className="text-lg mb-4 flex items-center transition-opacity duration-500">
                <FontAwesomeIcon icon={faUser} className="text-violet-400 mr-2" />
                16 years+
              </p>
            )}
            {visibleDetail >= 6 && (
              <p className="text-lg mb-4 flex items-center transition-opacity duration-500">
                <FontAwesomeIcon icon={faMapMarkerAlt} className="text-violet-400 mr-2" />
